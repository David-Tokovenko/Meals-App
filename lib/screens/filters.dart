...
enum Filter {
  ...
  vegan, // Веганська
  lowCarb, // Низьковуглеводна (новий фільтр)
}
...
class _FiltersScreenState extends State<FiltersScreen> {
  ...
  var _lowCarbFilterSet = false; // Змінна стану для фільтра "низьковуглеводна" (додано)
      ...
      body: WillPopScope(
        ...
        onWillPop: () async {
          ...
          Navigator.of(context).pop({
            ...
            Filter.lowCarb: _lowCarbFilterSet, // Додано новий фільтр
          });
