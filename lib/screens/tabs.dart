...
const kInitialFilters = {
  ...
  Filter.vegan: false,
  Filter.lowCarb: false, // Новий фільтр
};
...
class _TabsScreenState extends State<TabsScreen> {
  ...
  final availableMeals = dummyMeals.where((meal) {
    ...
    if (_selectedFilters[Filter.lowCarb]! && meal.carbs > 20) {
      return false; // Страви з понад 20г вуглеводів не включаємо
    }
    return true;
  }).toList(); // Перетворюємо результат фільтрації в список
